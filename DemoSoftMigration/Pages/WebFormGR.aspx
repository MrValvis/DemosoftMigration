<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebFormGR.aspx.cs" Inherits="DemoSoftMigration.Pages.WebFormsGr" %>
    ...
    <form id="form1" runat="server">
                ...
                <div class="collapse navbar-collapse" id="NavbarMenuBurger">
                    <div>
                        <ul class="nav navbar-nav navbar-right">
                            <li><a onclick="DatagridHelp('Greek');">Βοήθεια</a></li>
        ...
        <div class="DatabaseActionsMenu">
            <table class="DatabaseActionsTable">
                <tr>
                    <th>
                        <dx:ASPxButton ID="AddButton" runat="server" Text="Προσθήκη" Image-Url="~/Resources/add32x32.ico" OnClick="AddButton_Click" />
                    </th>
                    <th>
                        <dx:ASPxButton ID="ModifyButton" runat="server" Text="Τροποποίηση" Image-Url="~/Resources/modify32x32.ico" OnClick="ModifyButton_Click" />
                    </th>
                    <th>
                        <dx:ASPxButton ID="InspectButton" runat="server" Text="Έλεγχος" Image-Url="~/Resources/inspect32x32.ico" OnClick="InspectButton_Click" />
                    </th>
                    <th>
                        <dx:ASPxButton ID="RemoveButton" runat="server" Text="Αφαίρεση" Image-Url="~/Resources/Remove32x32.ico" OnClick="RemoveButton_Click" />
                    </th>
                    <th>
                        <dx:ASPxButton ID="RefreshButton" runat="server" Text="Ανανέωση" Image-Url="~/Resources/refresh32x32.ico" OnClick="RefreshButton_Click" />
                    </th>
                    <th>
                        <dx:ASPxButton ID="HistoryButton" runat="server" Text="Ιστορικό" Image-Url="~/Resources/history32x32.ico" OnClick="HistoryButton_Click" />
                    </th>
                    <th>
                        <dx:ASPxComboBox ID="ExportCombobox" runat="server" Width="285px" ImageUrlField="ImageUrl" TextField="Εξαγωγή σε" ValueField="Name" ShowImageInEditBox="True" EnableTheming="True" ReadOnly="false" Theme="iOS" AutoPostBack="True" OnSelectedIndexChanged="ExportCombobox_SelectedIndexChanged" Caption="Export To">
                            <Items>
        ...
        <div class="DataGridDiv" style="width: 100%; word-wrap: break-word; table-layout: fixed; font-size: smaller; overflow-x: scroll; overflow-y: hidden;">
            ...
            <dx:ASPxGridView ID="ASPxGridViewData" runat="server" ClientInstanceName="ASPxGridViewData" EnableTheming="True" Theme="iOS" Cursor="auto" KeyFieldName="OrderID" GridViewID="ASPxGridViewData">
                <SettingsPager AlwaysShowPager="True" NumericButtonCount="4" PageSizeItemSettings-Caption="Μέγεθος σελίδας">
