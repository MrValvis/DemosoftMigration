<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HistoryGR.aspx.cs" Inherits="DemoSoftMigration.Pages.HistorysGR" %>
...
<head runat="server">
    ...
    <title>Ιστορικό παραγγελίας</title>
</head>
<body>
                ...
                <div class="collapse navbar-collapse" id="NavbarMenuBurger">
                    <div>
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li><a onclick="HistoryHelp('Greek');">Βοήθεια</a></li>
                        </ul>
                    </div>
                </div>
            </div>
